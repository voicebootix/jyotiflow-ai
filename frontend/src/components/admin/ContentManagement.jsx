...
export default function ContentManagement() {
  ...
  if (!content || !Array.isArray(content) || content.length === 0) return <div>No content available.</div>;
  if (!satsangs || !Array.isArray(satsangs) || satsangs.length === 0) return <div>No satsangs available.</div>;
