...
const AllServicesTab = () => {
    ...
    const runAllTests = async () => {
        ...
        try {
            ...
            setError(`Failed to run all tests: ${globalError.message}`);
    ...
    const getOverallStats = () => {
        const totalServices = ALL_SERVICES_CONFIG.reduce((sum, category) => sum + category.services.length, 0);
    ...
    return (
        <div className="space-y-6" role="main" aria-label="All Services Test Suite">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4" role="region" aria-label="Test statistics">
                    ...
                    {stats.completedTests > 0 && (
                        <div className="mt-4" role="region" aria-label="Success rate progress">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2" role="progressbar" 
                                 aria-valuenow={stats.completedTests > 0 ? (stats.passedTests / stats.completedTests) * 100 : 0}
