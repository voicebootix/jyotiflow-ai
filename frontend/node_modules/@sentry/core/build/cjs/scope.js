...
class Scope {
   ...
   */
   captureException(exception, hint) {
    ...
    if (!this._client) {
      debugBuild.DEBUG_BUILD && logger.debug.warn('No client configured on scope - will not capture exception!');
      return eventId;
    }
   ...
   */
   captureMessage(message, level, hint) {
    ...
    if (!this._client) {
      debugBuild.DEBUG_BUILD && logger.debug.warn('No client configured on scope - will not capture message!');
      return eventId;
    }
   ...
   */
   captureEvent(event, hint) {
    ...
    if (!this._client) {
      debugBuild.DEBUG_BUILD && logger.debug.warn('No client configured on scope - will not capture event!');
      return eventId;
    }
