...
function startNewTrace(callback) {
  return currentScopes.withScope(scope => {
    ...
    debugBuild.DEBUG_BUILD && logger.debug.log(`Starting a new trace with id ${scope.getPropagationContext().traceId}`);
...
function _startRootSpan(spanArguments, scope, parentSampled) {
  ...
  if (!sampled && client) {
    debugBuild.DEBUG_BUILD && logger.debug.log('[Tracing] Discarding root span because its trace was not chosen to be sampled.');
