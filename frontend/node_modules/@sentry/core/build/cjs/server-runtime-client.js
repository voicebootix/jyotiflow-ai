 ...
 extends client.Client {
   ...
   */
   captureCheckIn(checkIn, monitorConfig, scope) {
    ...
    if (!this._isEnabled()) {
      debugBuild.DEBUG_BUILD && logger.debug.warn('SDK not enabled, will not capture check-in.');
      return id;
    }
    ...
    debugBuild.DEBUG_BUILD && logger.debug.log('Sending checkin:', checkIn.monitorSlug, checkIn.status);
