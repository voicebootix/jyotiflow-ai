...
function fill(source, name, replacementFactory) {
  ...
  try {
    ...
    debugBuild.DEBUG_BUILD && logger.debug.log(`Failed to replace method "${name}" in object`, source);
  }
}
...
function addNonEnumerableProperty(obj, name, value) {
  try {
    ...
    debugBuild.DEBUG_BUILD && logger.debug.log(`Failed to add non-enumerable property "${name}" to object`, obj);
  }
}
