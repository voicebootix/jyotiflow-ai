...
# Personalized Remedies Models and Endpoint
...
@router.post("/personalized-remedies", response_model=PersonalizedRemediesResponse)
async def get_personalized_remedies(
    ...
    try:
        ...
        logger.error(f"Error generating personalized remedies: {e}")
        raise HTTPException(
            status_code=500,
