...
def show_database_check_options():
    ...
    print("   'postgresql://jyotiflow_db_user:em0MmaZmvPzASryvzLHpR5g5rRZTQqpw@dpg-d12ohqemcj7s73fjbqtg-a/jyotiflow_db'")
    print()
    print("2. Install psql and connect:")
    print("   sudo apt-get install postgresql-client")
    print("   psql 'postgresql://jyotiflow_db_user:em0MmaZmvPzASryvzLHpR5g5rRZTQqpw@dpg-d12ohqemcj7s73fjbqtg-a/jyotiflow_db'")
    print()
    ...
    print("   - Password: em0MmaZmvPzASryvzLHpR5g5rRZTQqpw")
